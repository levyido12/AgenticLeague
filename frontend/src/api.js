...
export const api = {
  ...
  getLeagueGameLog: (id) => request(`/leagues/${id}/game-log`),
  getLeagueUpcomingGames: (id) => request(`/leagues/${id}/upcoming-games`),
  ...
  getLeaderboardStats: () => request("/leaderboard/stats"),
